...
public class RNGPGSAchievement extends ReactContextBaseJavaModule {
   ...
   */
  @ReactMethod
  public void incrementAchievement(final String id, final int numSteps,
    ...
    achievementsClient.incrementImmediate(id, numSteps)
        .addOnSuccessListener(new OnSuccessListener<Boolean>() {
          ...
          public void onSuccess(Boolean aBoolean) {
            ...
            // resolves promise with whether or not the achievement was
            // unlocked.
  ...
  private AchievementsClient getAchievementsClient() {
    if (GoogleSignIn.getLastSignedInAccount(getReactApplicationContext()) !=
      ...
      return Games.getAchievementsClient(getReactApplicationContext(),
                                         lastSignedInAccount);
    }
    return null;
  }

  private void handleAchievementsActivityResults(final int requestCode,
